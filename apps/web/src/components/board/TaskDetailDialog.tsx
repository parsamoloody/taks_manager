        ...
        <MutationForm mutation={mutation} ref={formRef} className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-full border border-slate-700/80 bg-slate-900/70 px-2.5 py-1.5 text-[11px] font-semibold text-slate-200 transition hover:border-sky-400/60 hover:text-white disabled:cursor-not-allowed disabled:opacity-60"
            >
            ...
            <button
              ...
              disabled={aiLoadingMode !== null}
              className="inline-flex items-center gap-1.5 rounded-full border border-slate-700/80 bg-slate-900/70 px-2.5 py-1.5 text-[11px] font-semibold text-slate-200 transition hover:border-fuchsia-400/60 hover:text-white disabled:cursor-not-allowed disabled:opacity-60"
            >
          ...
          <div className="flex flex-col-reverse gap-3 pt-2 sm:flex-row sm:items-center sm:justify-between">
            <button
              ...
              className="min-h-10 cursor-pointer rounded-xl px-3 text-sm font-medium text-rose-400 transition hover:bg-rose-400/10 hover:text-rose-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-300 disabled:cursor-not-allowed disabled:opacity-50"
            >
              Delete task
            </button>
...
function aiFieldShellClass(mode: "fix" | "enhance") {
  if (mode === "enhance") {
    return "rounded-2xl border border-fuchsia-400/40 bg-fuchsia-400/[0.08] p-1 shadow-[0_0_0_1px_rgba(192,132,252,0.18),0_0_18px_rgba(217,70,239,0.16)] animate-pulse";
  }

  return "rounded-2xl border border-sky-400/40 bg-sky-400/[0.08] p-1 shadow-[0_0_0_1px_rgba(56,189,248,0.18),0_0_18px_rgba(56,189,248,0.16)] animate-pulse";
}
